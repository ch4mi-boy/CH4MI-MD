...
console.log("CONNECTING CH4MI_MD-V1🧬...");
...
console.log('CH4MI_MD-V1 CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ᴄʜ4ᴍɪ_ᴍᴅ-ᴠ1 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴄʜ4ᴍɪ ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴄʜ4ᴍɪ_ᴍᴅ-ᴠ1❁*

*https://chat.whatsapp.com/BkLuob69UKbBzh1fb1IYtO*

> *❁ᴊᴏɪɴ ᴏᴜʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴄʜ4ᴍɪ_ᴍᴅ-ᴠ1❁*

*https://www.youtube.com/@CHAMI-BOY-OFC*

*╭⊱✫🐲 CH4MI_MD-V1 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *CH4MI_MD-V1*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *CH4MI BOY*
*│✫➠ - 🌐URL:* *https://github.com/ch4mi-boy/CH4MI-MD*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/xXZZQrk/a0cbc8b9a3873386.jpg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("HEY, CH4MI_MD-V1 STARTED ✅");
});
